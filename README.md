...
- [x] `fleet.yaml` schema and validation
- [x] Ollama node health checks and isolation
...
- [x] Real-time SSE dashboard (node health, routing, warmup, trace stream)
- [x] Execution trace viewer (`subagent-fleet trace`)
- [x] Generative UI dashboard (`subagent-fleet ui`)
- [x] Aider target support
